...
<html>
    <head>
        ...
        <meta property="og:title" content="Tu pedido en Alphatoner.mx" />
        
        <title>Tu pedido en Alphatoner.mx</title>
		<style type="text/css">
                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            	...
                                            	<img src="{{ url('/img/alphatoner/logo-correo.png') }}" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Confirmación de pedido</h1>
                                                       
                                                                <strong>¡Hola! {{$order->recipient_name}}</strong>
                                                                Gracias por tu pedido. 
                                                                <br>
                                                                Tu solicitud será revisada para enviarla lo antes lo posible, recibirás un correo electrónico con los datos de envio. 
                                                                <br><br>
                                                                Tu pedido será enviado a la dirección: <strong>{{$order->addressfull()}}</strong>.
                                                                <br><br>
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content01">
                                                            	Para cualquier duda sobre tu compra nos puedes contactar a nuestro correo <a href="mailto:contacto@alphatoner.mx">contacto@alphatoner.mx</a> ó a nuestro número de télefono  <a href="tel:01333826 2751">01(33)3826 2751</a>.
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a href="{{url('/compras/'.$order->shoppingCartID())}}" target="_blank">Detalles de tu pedido</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2016 Compuaccesorios Limited S.A. de C.V. Todos Los Derechos Reservados.</em>
																<br />
																Calle López Cotilla #828, Col. Americana CP 44160 Guadalajara Jalisco México.
																<br>
																<strong>Nuestra dirección de correo es:</strong>
																<br />
																<a href="mailto:contacto@alphatoner.mx">contacto@alphatoner.mx</a>
                                                            </div>
                                                        </td>
                                                    </tr>
